...
public class CreateAccountsStepDefinitions {
	...
	public void i_clicked_on_create_account() throws InterruptedException {
		...
		Thread.sleep(4000);
		String actualAccountTitle = Driver.getDriver().getTitle();
	...
	public void i_provide_accounts_details() {
		...
		WebElement list = Driver.getDriver().findElement(By.xpath("//select[@class='form-control']"));
		...
		WebElement list2 = Driver.getDriver()
				.findElement(By.xpath("(//select[@class='form-control main-element'])[1]"));
		Select select2 = new Select(list2);
		select2.selectByValue("Customer");

		createAccount.sicCode.sendKeys("233");

		WebElement list3 = Driver.getDriver()
				.findElement(By.xpath("(//select[@class='form-control main-element'])[1]"));
		Select select3 = new Select(list3);
		select3.selectByValue("Customer");

		WebElement list4 = Driver.getDriver()
				.findElement(By.xpath("(//select[@class='form-control main-element'])[2]"));
	...
	public void i_should_see_account_details_on_Accounts_page() throws InterruptedException {
		String actualTitleofAccout = Driver.getDriver().getTitle();
